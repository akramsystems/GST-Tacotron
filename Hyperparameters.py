...
class Hyperparameters():
    ...
    eval_text = 'especially as no more time is occupied, or cost incurred, in casting, setting, or printing beautiful letters|especially as no more time is occupied, or cost incurred, in casting, setting, or printing beautiful letters'
    ref_wav = '../../DATASETS/LJSpeech-1.1/wavs/LJ001-0012'
